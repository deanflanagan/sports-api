...
class Pregamestats(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        self.computed  = self.game.ft1 + self.game.ft2#
        super(Pregamestats, self).save(*args, **kwargs)
...
class Preview(models.Model):
    ...
    const = models.DecimalField(default=1.0, decimal_places=2,max_digits=3)